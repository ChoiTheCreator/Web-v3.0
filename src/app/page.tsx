    ...
    <div className="flex flex-row bg-bgDeepGray">
      <div className="w-full h-lvh flex flex-col justify-center items-center">
        ...
        <div className="flex justify-center items-center space-x-4">
          <button className="bg-primaryGray text-white font-Pretendard text-[18px] hover:bg-customGreen active:bg-custom-green rounded-lg px-16 py-8 space-y-4" onClick={handleProfessorClick}>
